...
import 'jorganise_tontine_card.dart';

class Jorganise extends StatefulWidget {
  const Jorganise({
    super.key,
  ...
  @override
  State<Jorganise> createState() => _JorganiseState();
}

class _JorganiseState extends State<Jorganise> {
