...
class ModifyTontineScreen extends StatefulWidget {
  const ModifyTontineScreen({
    Key? key,
...
class _ModifyTontineScreenState extends State<ModifyTontineScreen> {
  ...
  void initState() {
    setState(() {
      defaultTontineName = widget.tontine.tontineName;
      _selectedType = widget.tontine.type;
      _numberOfController.text = widget.tontine.numberOfType.toString();
      _contributeAmountController.text = widget.tontine.contribution.toString();
      _selectedDate1 = widget.tontine.startDate;
      _selectedDate2 = widget.tontine.firstPaiemntDate;
    });
    super.initState();
  }
                ...
                onPress: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    Future.delayed(const Duration(seconds: 2)).then((value) {
                      Navigator.pop(context);
                      _showBottomSheet(
                          context: context, tontine: widget.tontine);
                    });
                  }
                },
              ),
  ...
  void _showBottomSheet(
    ...
    int uniqueCode = tontine.uniqueCode;
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            ...
            child: ModifyTontineSheetContent(
